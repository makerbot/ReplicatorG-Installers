...
def scanAndUpdateInstaller(origFile="ReplicatorG.nsi", backupFile="bk.nsi",
	oldRelease='0031', newRelease='0033'):
        anyUpdated = False	
	redict = {}
...
if __name__ == "__main__":
	...
	parser.add_argument('last', help='last version number', default='0031')
	parser.add_argument('new', help='new version number', default ='0033')
